    ...
    action_start:
        ...
        else if(verb == "show") 
        {
            ...
            if(noun == "help")
            {
                ...
                cout << "look [north/south/east/west] - look into adjacent rooms" << endl;
                ...
                cout << "shoot [item name] - shoot someone or something (3 AP)" << endl;
                cout << "show inventory - displays inventory contents" << endl;
                cout << "show stats - displays HP and Ammo" << endl;
...
int main()
{
    ...
    Initialize(player3, newgrid, 3, player_num, 1, team_num);
    ...
    for(int i = 1; i < 11; i++)
    {
        Turn(player1, newgrid, plist, fout, i, 1);
        Turn(player2, newgrid, plist, fout, i, 2);
        Turn(player3, newgrid, plist, fout, i, 3);
    }
